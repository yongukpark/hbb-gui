...
;
const metadata = {
    title: 'Attention Head Naming Tool - Pythia-1.4B',
    description: 'Interactive tool for annotating and naming attention heads in Pythia-1.4B (24 layers x 16 heads)',
    generator: 'v0.app',
    icons: {
        icon: [
            {
